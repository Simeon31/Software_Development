...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        private void startButton_Click(object sender, EventArgs e)
        {
            ...
            //Reset the background colors after a new start
        ...
        private void sum_answer(object sender, EventArgs e)
        {
            ...
            if (answerBox != null)
            {
                // Change the NumericUpDown control background color to green
                // if answer is correct else change to red
        ...
        private void product_answer(object sender, EventArgs e)
        {
            ...
            if (answerBox != null)
            {
                // Change the NumericUpDown control background color to green
                // if answer is correct else change to red
                if (multiplier * multiplicand == product.Value && timeLeft > 0)
                {
        ...
        private void quotient_answer(object sender, EventArgs e)
        {
            // Select the whole answer in the NumericUpDown control.
            NumericUpDown answerBox = sender as NumericUpDown;
